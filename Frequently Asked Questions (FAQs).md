...
A: You must have Python, pip, openpyxl and pandas installed. 

## Q3: What are the steps to install Python?
A: 

**On a PC** : Open powershell and type `winget install Python.Python.3.14`. You must have admin rights to do this or have IT install it.
...
## Q8: I deleted or modifiied the original script or metadata template by accident. What should I do?
...
## Q9: What if I wrote manually created all my metadata from scratch and want to use it with the script?
